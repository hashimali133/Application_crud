...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="row justify-content-center mt-4">
            ...
            <form action="{{ route('product.store') }}" method="POST" class="form p-3" id="form-crud" name="myForm" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="password" class="form-control " placeholder="Leave Your Message"
                            id="description" cols="39" rows="3"></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" accept="image/*" class="form-control @error('name') is-invalid @enderror" id="file"
                            placeholder="Attach Photo" name="image">
